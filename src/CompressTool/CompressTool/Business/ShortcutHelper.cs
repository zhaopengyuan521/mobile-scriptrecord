...
namespace CompressTool
{
    ...
    public class ShortcutHelper
    {
        ...
        /// <param name="workingDirectory">工作路径</param>
        /// <returns></returns>
        public static bool CreateDesktopShortcut(string targetPath, string description, string iconLocation = null)
        {
            return ShortcutHelper.CreateShortcut(ShortcutHelper.GetDeskDir() + "\\" + description + ".lnk", targetPath, System.IO.Path.GetDirectoryName(targetPath), description, iconLocation);
        }
        ...
        /// <param name="workingDirectory">工作路径</param>
        /// <returns></returns>
        public static bool CreateProgramsShortcut(string targetPath, string description, string menuName, string iconLocation = null)
        {
            ...
            return ShortcutHelper.CreateShortcut(shortcutPath, targetPath, System.IO.Path.GetDirectoryName(targetPath), description, iconLocation);
        }
